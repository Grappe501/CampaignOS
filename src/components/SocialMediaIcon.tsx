/**
 * Inline brand-style icons (24×24 viewBox) for footer social links.
...
export default function SocialMediaIcon({ platform }: { platform: string }) {
  ...
  /* Generic link / unknown platform */
  return (
    <svg {...svgProps}>
      <path d="M14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7zm-9 4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-7h-2v7H5V9h7V7H5z" />
    </svg>
  )
}
